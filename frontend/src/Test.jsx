  ...
  return (
    <div>
      <div className="dropdown dropdown-end ml-40">
        ...
        >
          <li>
            <a onClick={() => handleDropdownSelection("current-day")}>Today</a>
          </li>
          <li>
            <a onClick={() => handleDropdownSelection("current-month")}>
              Current Month
            </a>
          </li>
          <li>
            <a onClick={() => handleDropdownSelection("last-7-days")}>
              Last 7 days
            </a>
          </li>
          <li>
            <a onClick={() => handleDropdownSelection("last-month")}>
              Last month
            </a>
          </li>
          <li>
            <a onClick={() => handleDropdownSelection("last-3-months")}>
              Last 3 months
            </a>
          </li>
        </ul>
