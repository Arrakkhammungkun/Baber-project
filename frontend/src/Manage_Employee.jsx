    ...
    <div>
      <LayoutAdmin>
        <Add_Employees
          ...
          onAddEmployee={handleAddService}
        />
        <Edit_Employees
        ...
        <div className="container pt-20 mx-auto ">
          <header className="mb-2 text-start ">
            <h1 className="text-2xl font-bold text-gray-800 p-2 ml-10">
              MANAGEMENT
            </h1>
          ...
          <div className="max-w-full mx-auto bg-white shadow-md rounded-lg p-4">
            ...
            <div className="flex justify-end mt-3 mb-8">
              <button
                onClick={handleAdd}
                className="md:px-[5rem] px-6 py-4 bg-black text-white text-sm rounded-md hover:bg-[#464545]"
              >
                +Add
              </button>
            </div>
