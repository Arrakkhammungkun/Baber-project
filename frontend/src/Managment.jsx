...
const Managment = () => {
  ...
  const handleStatusChange = (employeeId, newStatus) => {
    ...
    axios
      .patch(`${apiUrl}/employee/${employeeId}/`, { status: newStatus })
      .then((response) => {
          ...
          <div className="flex justify-between gap-4">
            ...
            <div className=" w-5/6 mr-2">
              ...
              {employees.map((employee, index) => (
                ...
                >
                  <div
                    className="bg-cover bg-center h-[150px] sm:h-[200px] sm:w-[150px] md:h-[150px] md:w-[120px] rounded-lg"
                    style={{
            ...
            <div className=" w-2/5">
              ...
              <div className="flex flex-col">
                ...
                <div className="flex justify-center mb-4 shadow-lg mt-10">
                  <button
                    onClick={() => handleNavigation("/admin/manage/employees")}
                    className="bg-[#242529] text-white uppercase px-6 py-2 rounded-md hover:bg-gray-700 transition duration-300 w-full"
                  >
                    managment barber
                  </button>
                </div>
                <div className="flex justify-center shadow-lg">
                  <button
                    onClick={() => handleNavigation("/admin/addservices")}
                    className="bg-[#242529] text-white uppercase px-6 py-2 rounded-md hover:bg-gray-700 transition duration-300 w-full"
                  >
                    managment service
                  </button>
